...
public enum GameResponses {
    ...
    CANT_EQUIP_CARD_FOR_SPELL("Error: you can't equip this card for this spell"),
    ...
    DEFENSIVE_OCCUPIED_DESTROYED("the defense position monster is destroyed. "),
    OFFENSIVE_OCCUPIED_DESTROYED("your opponent’s monster is destroyed. "),
    ATTACKER_TO_OFFENSIVE_OCCUPIED_DESTROYED("Your monster card is destroyed and you received  "),
