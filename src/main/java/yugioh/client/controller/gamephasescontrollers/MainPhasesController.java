...
import yugioh.client.model.cards.cardfeaturesenums.SummonTypes;
import yugioh.client.model.cards.monsters.GateGuardian;
import yugioh.client.model.cards.monsters.ManEaterBug;
import yugioh.client.model.cards.monsters.TerratigertheEmpoweredWarrior;
import yugioh.client.model.cards.monsters.TheTricky;
...
//                gameController.setDidPlayerSetOrSummonThisTurn(true);
    ...
    default void activateSpell(GameController gameController) throws GameException {
        System.out.println("activate spell called");
        Cell selectedCell = Cell.getSelectedCell();
        GameBoard playerGameBoard = gameController.getCurrentTurnPlayer().getGameBoard();
        if (selectedCell == null) {
            throw new GameException(GameResponses.NO_CARDS_SELECTED.response);
