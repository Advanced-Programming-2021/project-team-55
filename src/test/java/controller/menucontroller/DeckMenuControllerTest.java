...
import yugioh.client.model.cards.monsters.Babydragon;
import yugioh.client.model.cards.monsters.CrabTurtle;
import yugioh.client.model.cards.monsters.FeralImp;
import yugioh.client.model.cards.trapandspells.SolemnWarning;
...
class DeckMenuControllerTest {
    ...
    void getADeck() {
        ...
        try {
            String expected="Deck: first deck\nyugioh.client.yugioh.server.Main deck:\nMonsters:\n" + crabTurtle.toString() +"\n"+feralImp.toString()+
